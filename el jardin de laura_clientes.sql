...
CREATE TABLE `clientes` (
  ...
  `Condicion Frente al IVA` varchar(45) DEFAULT NULL,
  `Direccion comercial` varchar(45) DEFAULT NULL,
  `Color favorito` varchar(45) DEFAULT NULL,
  `Planta Favorita` varchar(45) DEFAULT NULL,
